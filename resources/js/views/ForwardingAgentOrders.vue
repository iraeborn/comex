    ...
    <table class="table table-sm table-container" v-else>
        ...
        <tbody v-for="(order, index) in page_orders">
            ...
            <template v-if="$parent.$route.query.status == 'missing_docs'">
                ...
                <td class="text-center">
                    <a v-if="order.drafts && order.drafts.certificate_phyto" class="btn btn-success" :href="order.drafts.certificate_phyto" target="_blank" title="View document"><i class="fas fa-file"></i></a>
                    <span v-else-if="order.required_docs && order.required_docs.certificate_phyto" class="btn btn-danger disabled" title="Document required"><i class="fas fa-times"></i></span>
                    <span v-else class="btn btn-info disabled" title="Document missing"><i class="fas fa-minus"></i></span><br/><br/>

                    <a v-if="order.originals && order.originals.certificate_phyto" class="btn btn-success" :href="order.originals.certificate_phyto" target="_blank" title="View document"><i class="fas fa-file"></i></a>
                    <span v-else-if="order.required_docs && order.required_docs.certificate_phyto" class="btn btn-danger disabled" title="Document required"><i class="fas fa-times"></i></span>
                    <span v-else class="btn btn-info disabled" title="Document missing"><i class="fas fa-minus"></i></span>
                </td>
                <td class="text-center">
                    <a v-if="order.mapa_docs && order.mapa_docs.draft_lpco" class="btn btn-success" :href="order.mapa_docs.draft_lpco" target="_blank" title="View document"><i class="fas fa-file"></i></a>
                    <span v-else-if="order.required_docs && order.required_docs.certificate_phyto" class="btn btn-danger disabled" title="Document required"><i class="fas fa-times"></i></span>
                    <span v-else class="btn btn-info disabled" title="Document missing"><i class="fas fa-minus"></i></span><br/><br/>

                    <a v-if="order.mapa_docs && order.mapa_docs.original_lpco" class="btn btn-success" :href="order.mapa_docs.original_lpco" target="_blank" title="View document"><i class="fas fa-file"></i></a>
                    <span v-else-if="order.required_docs && order.required_docs.certificate_phyto" class="btn btn-danger disabled" title="Document required"><i class="fas fa-times"></i></span>
                    <span v-else class="btn btn-info disabled" title="Document missing"><i class="fas fa-minus"></i></span>
                </td>
                <td class="text-center">
                    <span class="btn btn-info disabled"><i class="fas fa-minus"></i></span><br/><br/>

                    <a v-if="order.mapa_docs && order.mapa_docs.due" class="btn btn-success" :href="order.mapa_docs.due" target="_blank" title="View document"><i class="fas fa-file"></i></a>
                    <span v-else class="btn btn-danger disabled" title="Document missing"><i class="fas fa-times"></i></span>
                </td>
...
export default {
    ...
    methods: {
        ...
        Save: function ( order ) {
            ...
            this.$http.post('/api/orders-mapa', {
                order_id,
        ...
        _filterOrders: async function() {
            ...
            let response = await this.$http.get('/api/orders-mapa?' + this.getQuery());
