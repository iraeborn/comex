...
<ul class="nav nav-tabs">
  ...
  <li class="nav-item">
    <a href="#insurance" class="nav-link" data-toggle="tab">Insurance Agency</a>
  </li>
...
<div class="tab-content">
  ...
  <div class="tab-pane fade" id="insurance">
    <popcorn-insurance-agency-v2 ref="insurance_agency" v-model="insurance"></popcorn-insurance-agency-v2>
  </div>
...
<script>
  export default {
    ...
    methods: {
      Save: function () {
        this.$http.put('/api/insurance-profile/' + this.$route.params.id, this.$data.insurance).then(e => {
    ...
    mounted: async function () {
      ...
      this.$http.get('/api/insurance-profile/' + this.$route.params.id).then(e => {
          this.$data.insurance = e.body
