                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <input-icon type="text" icon="fas fa-user" v-model="signature.name" name="name"  />
                                </div>
                            </div>
                           <div class="col-12">
                                <div class="form-group">
                                  <div class="form-group">
                                        ...
                                        <div class="form-check form-check-inline mr-1">
                                            <input class="form-check-input" id="authentication1" v-model="signature.active" type="radio" value="0" name="authentication">
                                            <label class="form-check-label" for="authentication1">No</label>
                                        </div>
                                        <div class="form-check form-check-inline mr-1">
                                            <input class="form-check-input" id="authentication2" v-model="signature.active" type="radio" value="1" name="authentication">
                      ...
                      <div class="card-footer text-right">
                        <router-link :to="{ name: 'Serevices' }" class="btn btn-danger">Cancel</router-link>
...
export default {
  ...
  methods: {
    ...
    Store: function () {
      ...
      if(!this.$data.signature.name){
        this.$toaster.error('Name field is required');
        return;
      }
      this.$data.error = {};
      this.$http
        .post("/api/services", this.$data.signature)
        .then(function (e) {
          if (!e.body.success) {
