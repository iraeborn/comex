    ...
    <div class="w-100">
        <div class='form-group'>
            <multiselect
                ...
                :show-labels="false"
                :allow-empty="true"
                @select="updateData(type, $event, data.extendedProps.truck.id)"
                >
            </multiselect>
        </div>
        <div class="mt-2">
...
export default {
    ...
    data() {
        return {
            ...
            truckStatus: ['transit','unloading', 'completed'],
        }
    },
    ...
    methods: {
        ...
        updateData(type, value, truckId) {
            this.$emit('update-data', { type, value, truckId });
        },
