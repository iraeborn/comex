...
class OrderOriginalDocumentsJob extends BaseJob  implements ShouldQueue
{
    ...
    {
        $this->order = $order;
        $this->subject = 'Order Information '.$order->number.' - ORIGINAL DOCUMENTS';
        $this->view = 'mail.order_original_documents';
    }
